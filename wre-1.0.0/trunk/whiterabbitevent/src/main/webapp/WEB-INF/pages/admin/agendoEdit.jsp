	...
	<div class="panel">
		...
		<div class="panel-body text-center">
			<form name="agendoEditForm"
				ng-submit="updateAgendo(agendo)" novalidate>
...
{{agendo.agenTitle}}
						<div class="form-group col-md-6">
							<input type="hidden" ng-model="agendo.userId" value="${userId}"
								ng-init="agendo.userId=${userId}"> <label class="flot-left">Organization
								name <span style="color:red;">*</span></label> <input type="text" class="input-text form-control " 
								 id="orgName" ng-model="agendo.agenTitle" ng-maxlength="98" ng-minlength="3" 
