var SponsorPageViewController = function($scope, $http, $location, $routeParams,ngNotifier,objectService,stringService,filterFilter) {
	
		
	$scope.$on("$routeChangeSuccess", function() {
		$scope.eventId=$routeParams.eventId;
		
		$http.get('admin/sponsorsList?eventId='+$routeParams.eventId).success(
				function(sList) {
			//ngNotifier.notify("got data from ctrl");
...
//			/*************************************/
			...
			$scope.$watch('search', function (newVal, oldVal) {
				$scope.filtered = filterFilter($scope.sponsorsList, newVal);
